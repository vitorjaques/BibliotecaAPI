...
namespace BibliotecaAPI.Controllers
{
    ...
    public class LibrosController: ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IEnumerable<LibroDTO>> SelectLibros()
        {
        ...
        public async Task<ActionResult<LibroConAutoresDTO>> SelectLibroByID(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Libro>> CreateLibro(LibroCreacionDTO libroCreacionDTO)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<Libro>> UpdateLibro(int id, LibroCreacionDTO libroCreacionDTO)
        {
            if (libroCreacionDTO.AutoresIds is null || libroCreacionDTO.AutoresIds.Count == 0)
            {
                ModelState.AddModelError(nameof(libroCreacionDTO.AutoresIds),
